...
const CARD_VARIANTS = [CARD_SVG, CARD_ALT1, CARD_ALT2]
  ...
  return (
    <div className="ex-section">
      ...
      <div className="ex-section-content">
        <h3 className="ex-section-title">Scheduled Meetings</h3>
          ...
          {meetings.map((meeting, i) => (
            <div key={meeting.id} className="ex-meeting-item">
              ...
              <div className="ex-meeting-btn-wrapper">
                <img src={BTN_DARK} alt="" className="ex-meeting-btn-svg" draggable={false} />
                <button
