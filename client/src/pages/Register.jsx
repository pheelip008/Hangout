      ...
      return (
        <div className="flex min-h-screen items-center justify-center bg-gray-100">
          <div className="w-full max-w-md rounded-lg border-5 border-black bg-white p-8">
            <h1 className="mb-6 text-center text-3xl font-bold text-gray-900">Lets Hangout!</h1>
            <button
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <a href="/login" className="font-semibold text-blue-900 hover:underline">Log In</a>
            </p>
          </div>
        </div>
      );
